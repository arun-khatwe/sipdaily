    ...
    <div className="fixed flex justify-around items-center w-full bg-white py-2 shadow-md z-50">
      <div className="flex justify-center items-center gap-8 p-6">
        <ul className="flex space-x-8 border-b-2 border-gray-800 leading-loose font-serif text-xl xl:text-2xl xl:ml-32 text-red-500">
          <li
            className={`cursor-pointer ${activeSection === "home" ? "text-red-500" : ""
              }`}
          ...
          <li
            className={`cursor-pointer ${activeSection === "men" ? "text-red-500" : ""
              }`}
          ...
          <li
            className={`cursor-pointer ${activeSection === "mentoring" ? "text-red-500" : ""
              }`}
          ...
          <li
            className={`cursor-pointer ${activeSection === "missions" ? "text-red-500" : ""
              }`}
          ...
          <li
            className={`cursor-pointer ${activeSection === "contact" ? "text-red-500" : ""
              }`}
