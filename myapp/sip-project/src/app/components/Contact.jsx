        ...
        <div className="w-full flex flex-col lg:flex-row lg:gap-8">
            ...
            <div className="relative lg:right-12 lg:bottom-12">
              ...
              <div className="text-center lg:text-left mt-4">
                ...
                <p className="text-xs italic font-serif pt-2">
                  Donations are tax deductible. A registered 501(c)(3) EIN 99-0602117
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="w-full lg:w-1/3">
            ...
            >
              ...
              {submitStatus && (
                <div
                  className={`p-3 rounded-md ${submitStatus.success
              ...
              <button
                type="submit"
                className={`bg-[#1a365d] text-white p-2 w-full rounded-md font-serif mt-2 ${isSubmitting ? "opacity-70 cursor-not-allowed" : ""
                  }`}
